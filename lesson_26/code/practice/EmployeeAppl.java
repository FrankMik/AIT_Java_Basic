...
public class EmployeeAppl {
    public static void main(String[] args) {
        ...
        firma[1] = new SalesManager(101, "Bread", "Pit", 174, 30000, 0.1);
        firma[2] = new SalesManager(102, "Julia", "Roberts", 174, 30000, 0.1);
        firma[3] = new Worker(103, "Robert", "Douny jr.", 80, 20);
        firma[4] = new Worker(104, "Patricia", "Kaas", 174, 22);
